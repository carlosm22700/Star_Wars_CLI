...
* [Here's a Unix Cheat Sheet](https://learntocodewith.me/command-line/unix-command-cheat-sheet/) if you get stuck.
...
* In today's folder, create a directory called star_wars. Then touch a file called prompts.sh also in today's folder.

* For each prompt, write out the command you used in your terminal to complete the prompt in the prompts.sh file. This is how we will be grading your deliverable!

## Part I: Set the Scene

Make sure you cd into your new star_wars folder!
